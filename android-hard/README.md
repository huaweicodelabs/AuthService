...
## Introduction
The AppGallery Connect Auth service lets you quickly build a secure and reliable user authentication system for your app by integrating Auth Service capabilities, without needing to care about the facilities and implementations on the cloud.
...
## Getting Started
Before running the auth quickstart app, you need to:
...
3. Select your project and app in My projects, and go to Build > Auth service to enable the Auth service.
