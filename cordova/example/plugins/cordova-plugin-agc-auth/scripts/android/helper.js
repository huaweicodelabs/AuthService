...
function addDependencies(buildGradle) {
    ...
    var huaweiDependency = whitespace + 'classpath \'com.huawei.agconnect:agcp:1.4.2.301\' // huawei service dependency from cordova-plugin-agc-auth'
...
function addRepos(buildGradle) {
    ...
    var huaweiMavenRepo = whitespace + 'maven { url \'https://developer.huawei.com/repo/\' } // huawei service dependency from cordova-plugin-agc-auth'
    var modifiedLine = match[0] + '\n' + huaweiMavenRepo;
    ...
    // split the string on allprojects because jcenter is in both groups and we need to modify the 2nd instance
        ...
        var huaweisMavenRepo = whitespace + 'maven { url \'https://developer.huawei.com/repo/\' } // huawei service dependency from cordova-plugin-agc-auth'
